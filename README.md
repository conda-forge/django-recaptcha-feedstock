About django-recaptcha-feedstock
================================
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3849&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/django-recaptcha-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `django-recaptcha` can be installed with `conda`:
...
```
mamba install django-recaptcha
```

It is possible to list all of the versions of `django-recaptcha` available on your platform with `conda`:
...
```
mamba search django-recaptcha --channel conda-forge
```
...
mamba repoquery search django-recaptcha --channel conda-forge

# List packages depending on `django-recaptcha`:
mamba repoquery whoneeds django-recaptcha --channel conda-forge

# List dependencies of `django-recaptcha`:
mamba repoquery depends django-recaptcha --channel conda-forge
```
